class SnakeGame {
    ...
    keyDown(event) {
        if (event.keyCode === 38 && this.yVelocity !== 1) {
            this.yVelocity = -1;
            this.xVelocity = 0;
        } else if (event.keyCode === 40 && this.yVelocity !== -1) {
            this.yVelocity = 1;
            this.xVelocity = 0;
        } else if (event.keyCode === 37 && this.xVelocity !== 1) {
            this.yVelocity = 0;
            this.xVelocity = -1;
        } else if (event.keyCode === 39 && this.xVelocity !== -1) {
            this.yVelocity = 0;
            this.xVelocity = 1;
        }
    }
